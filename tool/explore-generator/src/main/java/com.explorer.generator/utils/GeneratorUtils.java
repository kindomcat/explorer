package com.explorer.generator.utils;

import com.explorer.generator.entity.ColumnEntity;
import com.explorer.generator.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            columnEntity.setUpperColumn(column.get("columnName").toUpperCase());
            //列名转换成Java属性名
            ...
            if(columnName.equals("attr1")||columnName.equals("attr2")||columnName.equals("attr3")||columnName.equals("attr4")){
                continue;
            }
            if(columnName.equals("crt_time")||columnName.equals("crt_user")||columnName.equals("crt_name")||columnName.equals("crt_host")){
                continue;
            }
            if(columnName.equals("upd_time")||columnName.equals("upd_user")||columnName.equals("upd_name")||columnName.equals("upd_host")){
                continue;
            }
